jQuery(document).ready(function($){
  ...
  function mover() {
    ...
    if (indice === totalImagenes) {
      setTimeout(() => {
        imagenes.style.transform = 'translateX(0)'; // Vuelve al inicio sin animación
        indice = 0;
        setTimeout(() => {
          imagenes.style.transition = 'transform 1s ease-in-out'; // Reactiva la transición
        }, 50);
      }, 1000); // Espera 1 segundo antes de reiniciar el ciclo
    } else {
